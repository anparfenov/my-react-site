export const aboutI18N = {
	ru: {
		...
		vkDescription: 'вк',
		githubDescription: 'тут лежат мои основные репы: этот сайт, проекты из секции "проекты", разные либы, стартеры',
		gitlabDescription: 'тут все остальное: в основном тестовые задания и всякие тестовые проекты',
