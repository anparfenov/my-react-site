...
export const cvI18N: TranslationObject = {
  ru: {
    seo: {
      title: 'Резюме | Андрей Парфенов',
      description: 'Резюме',
    },
    ...
    jobKoshelek: {
      ...
      text2:
        'Работа с ssr, микросервисной архитектурой, webpack module federation',
      text3: 'Написание unit/e2e тестов для vue компонентов',
      text4:
        'Сделал новый раздел на сайте, редактор статей, сервис авторизации',
    },
    jobRozario: {
...
export const cvData: Readonly<CV> = {
  nameLang: 'cv.name',
  ...
  skills: [
    {
      ...
      tech: [
        ...
        },
        {
          ...
          color: 'white',
          bgColor: '#dd4a24',
          classList: 'c-lang--html',
        },
        {
          name: 'css',
          color: 'white',
          bgColor: '#196fb4',
          classList: 'c-lang--css',
        },
      ],
    },
    {
      ...
      tech: [
        {
          ...
          color: 'white',
          bgColor: '#41b883',
          classList: 'c-lang--vue',
        },
        {
          name: 'svelte',
          color: 'white',
          bgColor: '#f73c00',
          classList: 'c-lang--svelte',
        },
        {
          name: 'react',
          color: 'black',
  ...
  jobs: [
    {
      ...
      description: [
        { textLang: 'cv.jobVK.text' },
        { textLang: 'cv.jobVK.text2' },
      ],
    },
    {
      company: 'Кошелек',
    ...
    },
    {
      ...
      description: [{ textLang: 'cv.jobSeventest.text' }],
    },
  ],
  educationList: [
    {
...
export function isSkill(data: unknown): data is Skill {
  return (
    (data as Skill).tech !== undefined || (data as Skill).list !== undefined
  );
}
